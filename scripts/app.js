(function(){
  ...
  // Updates a weather card with the latest weather forest. If the card
  ...
  app.updateForecastCard = function(data){
    ...
    // on the card,if it's not bail, if it is, cotinue and update the
   ...
   */
   app.getForecast = function(key, label){
    ...
    request.onreadystatechange = function(){
      if(request.readyState === XMLHttpRequest.DONE){
        ...
        // Return the initial weather forescast since no data is available.
   ...
   // inital all of the cards and attempt to get the latest forecast data
